/* ═══════════════════════════════════════════════════════════
   Indo Valley Public School — interaction layer
   ═══════════════════════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  var revealIO = new IntersectionObserver(function (entries) {
    entries.forEach(function (en) {
      // also catch elements the observer skipped past during a fast jump
  ...
  // safety sweep: anything already at or above the fold gets revealed anyway
  ...
  (function () {
    ...
    function draw() {
      ...
      for (var i = 0; i < pts.length; i++) {
        ...
        ctx.fillStyle = dark ? 'rgba(255,194,77,' + p.a + ')' : 'rgba(28,66,136,' + p.a + ')';
        ctx.fill();
      }
