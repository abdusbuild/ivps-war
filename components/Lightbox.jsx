export default function Lightbox() {
  return (
    ...
    >
      ...
      <button
        className="lightbox__nav lightbox__nav--prev absolute top-1/2 -mt-[26px] left-[18px] w-[52px] h-[52px] text-[30px] leading-none rounded-full grid place-items-center cursor-pointer text-gold-400 bg-white/10 border border-white/16"
        id="lbPrev"
      ...
      <button
        className="lightbox__nav lightbox__nav--next absolute top-1/2 -mt-[26px] right-[18px] w-[52px] h-[52px] text-[30px] leading-none rounded-full grid place-items-center cursor-pointer text-gold-400 bg-white/10 border border-white/16"
        id="lbNext"
